...
namespace IHSA_Backend.Models
{
    ...
    public class EventModel : IBaseModel
    {
        ...
        [FirestoreProperty] public IEnumerable<EventElementOrderModel> EventOrder { get; set; } = new List<EventElementOrderModel>();
    ...
    public class EventRequestModel
    {
        ...
        public IEnumerable<EventElementOrderRequestModel> EventOrder { get; set; } = new List<EventElementOrderRequestModel>();
